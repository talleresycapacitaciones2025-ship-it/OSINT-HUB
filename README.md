...
- 🎨 **3 temas** intercambiables
- 🔍 **Búsqueda en tiempo real**
- 🧩 **Filtros por categoría**
- 📂 **10 categorías, 63 herramientas**
- ✅ **Verificación manual** (fetch HEAD con timeout)
- 🔗 **URL persistente** (comparte búsquedas y filtros)
- 💾 **Guardado local** del estado de cada herramienta
- 🚫 **Sin exportaciones, sin reportes, sin tracking**
